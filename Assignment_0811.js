...
let listOfStates = [
            ...
            var str = JSON.stringify(listOfStates);
            var fs = require('fs');
            fs.writeFile("Assignment_JSONFile.JSON",str, function(err,result){
                if (err) console.log('error',err);
            });
            

         console.log('The JSON format for the file is: ' + str);
    
console.log('_______________________________________________________________');
//Writing this file as a separate JSON file
